...
var AudioManager = cc.Class({
    ...
    playRawMusic(path) {
        ...
        this.m_musicId = this.playAudio(path, true, this.m_nMusicVolume);
    ...
    rePlayMusic: function () {
        ...
        if (this.m_music_path != null) {
            this.m_musicId = this.playAudio(this.m_music_path, true, this.m_nMusicVolume);
            return this.m_musicId;
        }
    },
    ...
    playSound: function (path, isLoop) {
        ...
        if (this.canPlaySound != undefined) {
            if (this.canPlaySound) {
                ...
                return this.playAudio(path, lp, this.m_nSoundVolume);
            } else {
                return -1;
            }
        }
    ...
    playMusicNotControlledBySwitch: function (path, loop) {
        ...
        this.m_musicId = this.playAudio(path, loop, !this.m_bMusicSwitch ? 0 : this.m_nMusicVolume);
        this.m_music_path = path;
        cc.sys.localStorage.setItem("MUSIC_BACKGROUND", path);
        return this.m_musicId;
    },
