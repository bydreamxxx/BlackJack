...
cc.Class({
    ...
    showOutCard: function (cardlist, isabnormal) {
        ...
        var cards = py.sortOutCards(cardlist);
        cc.log('cardlist.length:',cardlist.length+'------',)
        if (cardlist.length == 0 || cardlist[0] == 0) {
    ...
    playAnimation: function (outType, card) {
        ...
        cc.log('上家--------card.y:', card.y, 'pos.x:', pos.x, 'pos.y:', pos.y);
        switch (outType) {
            case 3:
