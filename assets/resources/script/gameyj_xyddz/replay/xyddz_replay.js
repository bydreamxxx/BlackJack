...
cc.Class({
    ...
    initUiScript: function (bool) {
        this._uiComponents = [];
        if (bool) {
            this._uiComponents.push(this.node.getComponentInChildren('xyddz_replay_down_ui'));
            this._uiComponents.push(this.node.getComponentInChildren('xyddz_replay_right_ui'));
            this._uiComponents.push(this.node.getComponentInChildren('xyddz_replay_left_ui'));
        }
    },
