...
////////////////////////////////////////////玩家操作通信信息枚举begin/////////////////////////////
var Teenpatti_PlayerEvent = cc.Enum({
    TEENPATTI_PLAYER_COME_BACK: 'dsz_player_come_back', //玩家重连消息
    TEENPATTI_PLAYER_ENTER: 'dsz_player_enter', //玩家进入游戏
    TEENPATTI_PLAYER_READY: 'dsz_player_ready', //玩家准备消息
    ...
    TEENPATTI_PLAYER_COIN_CHANGE: 'dsz_player_coin_change', //金币充值修改
    TEENPATTI_PLAYER_AUTO_CHANGE: 'dsz_player_auto_change', //斗三张托管状态
});
////////////////////////////////////////////玩家操作通信信息枚举end/////////////////////////////
var Teenpatti_PlayerED = new cc.dd.EventDispatcher();

////////////////////////////////////////////玩家基础信息Begin///////////////////////////////
var Teenpatti_PlayerData = cc.Class({
    properties: {
        userId: 0, //玩家id
    ...
    setPlayerGameInfo: function (roleInfo) {
        ...
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_INIT_DATA, this.userId);
    ...
    updatePlayerState: function (state) {
        ...
        // DSZ_PlayerED.notifyEvent(Teenpatti_PlayerEvent.DSZ_PLAYER_OP_STATE, this.userId);
    },
    ...
    comeBack: function () {
        ...
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_COME_BACK, this.userId);
    },
     ...
     */
    enterGame: function () {
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_ENTER, this.userId);
    },
    /**
     * 玩家准备
     */
    setReady: function (isReady) {
        ...
        cc.log('====================ready');
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_READY, this.userId);
    },
    ...
    setOnLine: function (isOnline) {
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.New_PLAYER_ISONLINE, [this, isOnline]);
    },
     ...
     */
    exit: function () {
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLYER_EXIT, this.playerCommonInfo);
    },
     ...
     */
    updateCoin: function(){
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_COIN_CHANGE, this.userId);
    },
    ...
    setPlayerAutoState: function(status){
        ...
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_AUTO_CHANGE, this.userId);
    },
    /////////////////////////////玩家通信操作end///////////////////////////////////////
});
////////////////////////////////////////////玩家基础信息End///////////////////////////////
///////////////////////////////////////////////玩家管理器Begin/////////////////////////////
var Teenpatti_PlayerMgr = cc.Class({
    s_Teenpatti_player_data: null,
    statics: {
        Instance: function () {
            if (!this.s_Teenpatti_player_data) {
                this.s_Teenpatti_player_data = new Teenpatti_PlayerMgr();
            }
            return this.s_Teenpatti_player_data;
        },

        Destroy: function () {
            if (this.s_Teenpatti_player_data) {
                this.s_Teenpatti_player_data = null;
            }
        },
    },
    ...
    genPlayerData: function (role_info) {
        ...
        var playerData = new Teenpatti_PlayerData;
    ...
    updatePlayerNum: function () {
        ...
        this.viewerInfo = [];
        Teenpatti_PlayerED.notifyEvent(Teenpatti_PlayerEvent.TEENPATTI_PLAYER_CLEAR);
    },
...
module.exports = {
    Teenpatti_PlayerMgr: Teenpatti_PlayerMgr,
    Teenpatti_PlayerED: Teenpatti_PlayerED,
    Teenpatti_PlayerEvent: Teenpatti_PlayerEvent,
};