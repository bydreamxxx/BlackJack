    ...
    showBottomCard: function (cardlist) {
        ...
        var playFinished = (event) => {
            ...
            self.scheduleOnce(function () {
                cc.find('top/dipai_info', self.node.parent).getComponent(cc.Animation).play('dipai_ani_jbc_1');
            ...
            if (!last) {
                ...
                switch (type) {
                    ...
                    case 8://飞机
                        ...
                        break;
                    case 10://炸弹
                        cc.find('Canvas/root').getComponent('ddz_game_jbc').playBombAnimation('you');
                        break;
                    case 11://火箭
                        cc.find('Canvas/root').getComponent('ddz_game_jbc').playRocketAnimation('2');
                        break;
                    default:
                        break;
                }
