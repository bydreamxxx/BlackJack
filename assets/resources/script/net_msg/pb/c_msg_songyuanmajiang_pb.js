...
module.exports.sy_desk_info = sy_desk_info;

let sy_req_desk_rule = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_desk_rule = sy_req_desk_rule;

let sy_game_ack_act_hu = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_game_ack_act_hu = sy_game_ack_act_hu;

let sy_ack_send_current_result = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_send_current_result = sy_ack_send_current_result;

let sy_ack_game_opening = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_opening = sy_ack_game_opening;

let sy_ack_roomInit = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_roomInit = sy_ack_roomInit;

let sy_ack_enterDesk = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_enterDesk = sy_ack_enterDesk;

let sy_req_leave_status = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_leave_status = sy_req_leave_status;

let sy_ack_leave_status = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_leave_status = sy_ack_leave_status;

let sy_req_sponsor_dissolve_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_sponsor_dissolve_room = sy_req_sponsor_dissolve_room;

let sy_ack_sponsor_dissolve_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_sponsor_dissolve_room = sy_ack_sponsor_dissolve_room;

let sy_req_response_dissolve_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_response_dissolve_room = sy_req_response_dissolve_room;

let sy_ack_response_dissolve_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_response_dissolve_room = sy_ack_response_dissolve_room;

let sy_req_dissolve_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_dissolve_room = sy_req_dissolve_room;

let sy_ack_dissolve_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_dissolve_room = sy_ack_dissolve_room;

let sy_req_exit_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_exit_room = sy_req_exit_room;

let sy_ack_exit_room = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_exit_room = sy_ack_exit_room;

let sy_ack_playerEnter = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_playerEnter = sy_ack_playerEnter;

let sy_req_ready = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_ready = sy_req_ready;

let sy_ack_ready = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_ready = sy_ack_ready;

let sy_ack_opening = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_opening = sy_ack_opening;

let sy_bc_moPai = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_bc_moPai = sy_bc_moPai;

let sy_ack_game_overturn = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_overturn = sy_ack_game_overturn;

let sy_ack_game_deal_cards = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_deal_cards = sy_ack_game_deal_cards;

let sy_ack_game_send_out_card = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_send_out_card = sy_ack_game_send_out_card;

let sy_game_send_end_lottery = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_game_send_end_lottery = sy_game_send_end_lottery;

let sy_req_game_send_out_card = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_send_out_card = sy_req_game_send_out_card;

let sy_req_chi = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_chi = sy_req_chi;

let sy_ack_chi = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_chi = sy_ack_chi;

let sy_req_game_act_peng = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_act_peng = sy_req_game_act_peng;

let sy_ack_game_act_peng = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_act_peng = sy_ack_game_act_peng;

let sy_req_game_act_gang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_act_gang = sy_req_game_act_gang;

let sy_ack_game_act_gang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_act_gang = sy_ack_game_act_gang;

let sy_req_game_act_bugang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_act_bugang = sy_req_game_act_bugang;

let sy_ack_game_act_bugang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_act_bugang = sy_ack_game_act_bugang;

let sy_req_game_act_guo = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_act_guo = sy_req_game_act_guo;

let sy_ack_game_act_guo = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_act_guo = sy_ack_game_act_guo;

let sy_req_game_act_hu = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_act_hu = sy_req_game_act_hu;

let sy_req_game_ting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_game_ting = sy_req_game_ting;

let sy_ack_game_ting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_ting = sy_ack_game_ting;

let sy_ack_game_dabao = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_dabao = sy_ack_game_dabao;

let sy_ack_game_changbao = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_game_changbao = sy_ack_game_changbao;

let sy_req_remain_majiang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_remain_majiang = sy_req_remain_majiang;

let sy_ack_remain_majiang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_remain_majiang = sy_ack_remain_majiang;

let sy_req_change_majiang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_change_majiang = sy_req_change_majiang;

let sy_ack_change_majiang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_change_majiang = sy_ack_change_majiang;

let sy_ask_show_tingpai_tips = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ask_show_tingpai_tips = sy_ask_show_tingpai_tips;

let sy_ack_rob_remove_card = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_rob_remove_card = sy_ack_rob_remove_card;

let sy_ack_update_user_status = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_update_user_status = sy_ack_update_user_status;

let sy_req_reconnect = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_reconnect = sy_req_reconnect;

let sy_ack_reconnect = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_reconnect = sy_ack_reconnect;

let sy_ack_send_player_handinfo = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_send_player_handinfo = sy_ack_send_player_handinfo;

let sy_req_reloading_ok = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_reloading_ok = sy_req_reloading_ok;

let sy_ack_reloading_ok = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_reloading_ok = sy_ack_reloading_ok;

let sy_ack_finally_result = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_finally_result = sy_ack_finally_result;

let sy_ack_fen_zhang = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_fen_zhang = sy_ack_fen_zhang;

let sy_ack_user_info = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_user_info = sy_ack_user_info;

let sy_req_tingpai_out_card = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_tingpai_out_card = sy_req_tingpai_out_card;

let sy_game_ack_act_huangzhuangpais = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_game_ack_act_huangzhuangpais = sy_game_ack_act_huangzhuangpais;

let sy_ack_operator = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_operator = sy_ack_operator;

let sy_ack_dont_win_zero = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_dont_win_zero = sy_ack_dont_win_zero;

let sy_req_enter_match = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_enter_match = sy_req_enter_match;

let sy_ack_enter_match = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_enter_match = sy_ack_enter_match;

let sy_req_update_deposit = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_update_deposit = sy_req_update_deposit;

let sy_ack_update_deposit = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_update_deposit = sy_ack_update_deposit;

let sy_ack_update_coin = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_update_coin = sy_ack_update_coin;

let sy_req_chiting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_chiting = sy_req_chiting;

let sy_ack_chiting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_chiting = sy_ack_chiting;

let sy_jiaoInfos = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_jiaoInfos = sy_jiaoInfos;

let sy_req_pengting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_pengting = sy_req_pengting;

let sy_ack_pengting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_pengting = sy_ack_pengting;

let sy_req_gangting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_req_gangting = sy_req_gangting;

let sy_ack_gangting = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_gangting = sy_ack_gangting;

let sy_ack_bao = cc.Class({
    ctor(){
    },
    getContent(){
        let content = {};
...
module.exports.sy_ack_bao = sy_ack_bao;
