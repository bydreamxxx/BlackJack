...
var ahmj_Control_Combination_ui = require( "ahmj_Control_Combination_ui" );
...
var cc_GameMenu = cc.Class({
     ...
     */
    guo: function () {
        var msg = new cc.pb.aohanmj.aohan_req_game_act_guo();
        msg.setUserid(dd.user.id);
        msg.setGuotype(this.getGuoType());
        cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_game_act_guo,msg,"aohan_req_game_act_guo");
    },
    ...
    chi: function () {
        ...
        if(UserPlayer.chi_options.length == 1){
            //只有一个吃，直接吃
            var msg = new cc.pb.aohanmj.aohan_req_chi();
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_chi,msg,"aohan_req_chi");
    ...
    peng: function () {
        ...
        var msg = new cc.pb.aohanmj.aohan_req_game_act_peng();
        msg.setUserid(dd.user.id);

        var pengCard = new cc.pb.jilinmajiang.CardInfo();
        pengCard.setId(DeskData.Instance().last_chupai_id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_game_act_peng,msg,"aohan_req_game_act_peng");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    onSeclectedGang: function ( selectedList ) {
        ...
        ahmj_Control_Combination_ui.Instance().onCloseCombinationUi();
    },
    ...
    gang: function () {
        ...
        if( gangOption.cardList.length == 1 ) {
            ...
            if( isGangTing ) {
                ...
                ahmj_Control_Combination_ui.Instance().getAllCombinationList( gangOptionList1, gangOptionList,true);

            } else {
                ahmj_Control_Combination_ui.Instance().getAllCombinationList( gangOption.cardList, gangOptionList,false);
            }
    ...
    ting: function () {
        ...
        //
        //
        // var msg = new cc.pb.aohanmj.aohan_req_tingpai_out_card();
        // msg.setCardid(-1);
        // msg.setTingtype(1);
        // cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_tingpai_out_card,msg,"aohan_req_tingpai_out_card");
     ...
     */
    hupai: function () {
        var msg = new cc.pb.aohanmj.aohan_req_game_act_hu();
        msg.setUserid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_game_act_hu,msg,"aohan_req_game_act_hu");
    },
    /**
     * 取消按钮回调
     */
    ...
    sendGangPai:function (gang_option) {
        var msg = new cc.pb.aohanmj.aohan_req_game_act_gang();
        ...
        cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_game_act_gang,msg,"aohan_req_game_act_gang");
        cc.dd.NetWaitUtil.net_wait_start();
    },
