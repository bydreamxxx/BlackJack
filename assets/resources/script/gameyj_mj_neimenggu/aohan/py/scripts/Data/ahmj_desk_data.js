...
var JieSanData = require('ahmj_jiesan_data').JieSanData.Instance();
...
var AHMJDeskData = cc.Class({
    ...
    jiesuan: function (msg) {
        cc.log('【数据】AHMJ普通结算 开始'+this.isPlayHuAni);
        if(msg){
    ...
    isFriend: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.AHMJ_FRIEND;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.AHMJ_FRIEND];
        return g_id && c_name;
    },

    isReplay: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.AHMJ_FRIEND;
        var c_name = cc.dd.SceneManager.getCurrScene().name=='ahmj_replay_game';
        return g_id && c_name;
    },

    isJBC: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.AHMJ_GOLD;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.AHMJ_GOLD];
        return g_id && c_name;
    },

    isMatch: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.AHMJ_MATCH;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.AHMJ_MATCH];
        return g_id && c_name;
    },

    isInMaJiang: function () {
        let scenename = cc.dd.SceneManager.getCurrScene().name;
        if(scenename == cc.dd.Define.GameId[cc.dd.Define.GameType.AHMJ_GOLD] || scenename == cc.dd.Define.GameId[cc.dd.Define.GameType.AHMJ_FRIEND] || scenename == 'ahmj_replay_game' || cc.dd.Define.GameId[cc.dd.Define.GameType.AHMJ_MATCH]){
            return true
        }else{
            return false;
        }
