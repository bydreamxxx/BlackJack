...
cc.Class({
    ...
    onLoad: function () {
        cc.log('ahmj_player_down_ui onLoad');
        ...
        this.menuList = cc.find("Canvas/game_menu_list").getComponent("ahmj_game_menu_list");
    ...
    touchStart: function (event) {
        ...
        if (pai_touched) {
            ...
            if (this.touchCardMode == TouchCardMode.DA_TING_PAI) {
                this.closeJiaoInfo();
                cc.log("ahmj touchStart openJiaoInfo");
    ...
    touchEnd: function (event) {
        ...
        if (!this.pai_touched) {
            ...
            if (this.touchCardMode == TouchCardMode.DA_TING_PAI) {
                this.closeJiaoInfo();
                cc.log("ahmj touchEnd openJiaoInfo");
                this.openJiaoInfo(this.pai_touched.cardId);
            }
        }
            ...
            if (this.yidong_pai.node.y > -267 * this._node_scale_y) {
                ...
                if (UserPlayer.isTempBaoTing) {
                    ...
                    if (UserPlayer.hasMoPai()) {
                        // if(this.touchCardMode == TouchCardMode.DA_TING_PAI){
                        //     cc.log("ahmj touchEnd sendOutCard");
                        //     UserPlayer.setJiaoInfo(this.yidong_pai.cardId);
                        // }
    ...
    biaojiPai: function (selectId) {
        ...
        for (var i in userList) {
            var com = userList[i].getComponent('ahmj_player_down_ui');
    ...
    sendTingPai: function (playCardId, tingType) {
        ...
        cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_tingpai_out_card, msg, "cmd_aohan_req_tingpai_out_card");
    ...
    sendOutCard: function (cardID) {
        ...
        this.quxiaoBiaoji();
        var msg = new cc.pb.aohanmj.aohan_req_game_send_out_card();
        msg.setCardid(cardID);
        cc.gateNet.Instance().sendMsg(cc.netCmd.aohanmj.cmd_aohan_req_game_send_out_card, msg, "aohan_req_game_send_out_card");
        cc.dd.NetWaitUtil.net_wait_start();
    },
