...
var ccjb_handler = cc.Class({
    ...
    extends: ahmj_net_handler_ahmj.constructor,
    ctor: function () {
        cc.log("ahmj_net_handler_ahmj 子类");
    },
    ...
    on_aohan_ack_roomInit: function( msg ) {
        cc.log("jbc on_aohan_ack_roomInit");
    ...
    on_aohan_ack_send_current_result: function( msg ) {
        this._super(msg);
        ahmj_desk_data_jbc.getInstance().setIsStart(DeskData.Instance().isFriend()==false);
    ...
    on_aohan_ack_reconnect: function( msg ) {
        ...
        if(msg.deskrules.desktype == cc.dd.Define.GameType.AHMJ_MATCH){
            this._super(msg);
            return;
        }
        ...
        ahmj_desk_data_jbc.getInstance().setIsReconnect( true );
        ahmj_desk_data_jbc.getInstance().setIsStart( true );
        DeskData.Instance().setIsStart( true );
        ...
        ahmj_desk_data_jbc.getInstance().setData( jlmjJbcCfgItem );
