...
cc.Class({
    ...
    setMenus: function(player){
        ...
        if(player.canbuhua){
            this.onShow_list.push(this.getMenu(this.menu_list, this.require_menu_type.BU_HUA));
        }else if(player.canhu == this.require_hupai_type.CAN_HU_TRUE_DUIBAO || player.canhu == this.require_hupai_type.CAN_HU_TRUE_MOBAO){
