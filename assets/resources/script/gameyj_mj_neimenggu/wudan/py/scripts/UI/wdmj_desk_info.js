...
var baseDeskInfo = cc.Class({
    ...
    initProperties: function () {
        this.logo = cc.find("Canvas/desk_node/c-logo-wudan").getComponent(cc.Sprite);
        this.run_score = cc.find("Canvas/wdmj_run_score");
    ...
    openBaoPai() {
        ...
        if (baoPaiValue >= 0 && this._baoPai) {
            ...
            this.baopai.frame.node.width = 56;
            this.baopai.frame.node.height = 79;
        }
    },
    ...
    getGameGuiZe: function () {
        ...
        let gz_arr_box = [];
        gz_arr_box.push(cc.dd.Text.TEXT_PY_RULE_141.format([RoomMgr.Instance()._Rule.usercountlimit]));
        ...
        gz_arr_info.push({ str: Text.TEXT_PY_RULE_141.format([RoomMgr.Instance()._Rule.usercountlimit]), nodetype: 0 });
        ...
        let title = cc.dd.Text.TEXT_PY_RULE_142.format(this.require_playerMgr.Instance().playerList.length);
    ...
    sendReloadOK: function () {
        var msg = new cc.pb.wudanmj.wudan_req_reloading_ok();
        cc.gateNet.Instance().sendMsg(cc.netCmd.wudanmj.cmd_wudan_req_reloading_ok, msg, "wudan_req_reloading_ok");
    },
    ...
    py_dissolve_room_req: function () {
        ...
        var msg = new cc.pb.wudanmj.wudan_req_sponsor_dissolve_room();
        msg.setSponsorid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.wudanmj.cmd_wudan_req_sponsor_dissolve_room, msg, "wudan_req_sponsor_dissolve_room");
    },
    ...
    callNetReadFunc: function () {
        var msg = new cc.pb.wudanmj.wudan_req_ready();
        cc.gateNet.Instance().sendMsg(cc.netCmd.wudanmj.cmd_wudan_req_ready, msg, "wudan_req_ready");
    ...
    cleanTuoGuanBtnCallBack: function () {
        if (this.require_DeskData.Instance().isoffline) {
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.wudanmj.cmd_wudan_req_update_deposit, req, "wudan_req_update_deposit", true);
        }
    },
    ...
    getFJInfo() {
        ...
        // fj_arr.push(Text.TEXT_PY_RULE_141.format([RoomMgr.Instance()._Rule.usercountlimit]));
    ...
    onClickRunScore(event, data) {
        ...
        var msg = new cc.pb.wudanmj.wudan_req_paofen();
        msg.setScore(Number(data));
        cc.gateNet.Instance().sendMsg(cc.netCmd.wudanmj.cmd_wudan_req_paofen, msg, "wudan_req_paofen", true);
