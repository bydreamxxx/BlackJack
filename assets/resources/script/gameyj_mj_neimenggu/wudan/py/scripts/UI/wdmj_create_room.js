...
cc.Class({
        ...
        switch (data) {
            case "rs1":
                ...
                var conf = cost_room_cards_config.getItemList(function (item) {
                    return item.id == cc.dd.Define.GameType.WDMJ_FRIEND && item.player_num == 4;
                }.bind(this));
            ...
            case "rs2":
                ...
                var conf = cost_room_cards_config.getItemList(function (item) {
                    return item.id == cc.dd.Define.GameType.WDMJ_FRIEND && item.player_num == 3;
                }.bind(this));
            ...
            case "rs3":
                ...
                var conf = cost_room_cards_config.getItemList(function (item) {
                    return item.id == cc.dd.Define.GameType.WDMJ_FRIEND && item.player_num == 2;
                }.bind(this));
    ...
    sendCreateRoom: function (data, isProxy) {
        ...
        cc.sys.localStorage.setItem(cc.dd.user.id + '_last_enter_game', cc.dd.Define.GameType.WDMJ_FRIEND);
    ...
    getXLGameRule(data, qsOrJs){
        ...
        var pbData = new cc.pb.room_mgr.wudan_req_createdesk();
    ...
    setXLGameRule(rule){
        let _rule = rule.rule.mjWudanRule;

        let qsOrJs = 0;
        var conf = cost_room_cards_config.getItemList(function (item) {
            return item.id == cc.dd.Define.GameType.WDMJ_FRIEND && item.player_num == _rule.usercountlimit;
        }.bind(this));
