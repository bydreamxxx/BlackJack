var pai3d_down = cc.Class({
    ...
    statics: {
        ...
        Instance: function () {
            if(!this.s_pai3d_cfg){
                this.s_pai3d_cfg = new pai3d_down();
            }
    ...
    ctor: function () {
        ...
        var pai_cfg = require('nmmj_pai_cfg_down_2d_yellow');
        ...
        //结算开牌配置
        this.shoupai_kaipai_up_cfg = pai_cfg.shoupai_kaipai_up_cfg;
        this.shoupai_kaipai_close_cfg = pai_cfg.shoupai_kaipai_close_cfg;
        this.shoupai_kaipai_close_up_cfg = pai_cfg.shoupai_kaipai_close_up_cfg;
    },
});

module.exports = pai3d_down;