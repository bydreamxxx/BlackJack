...
var UserPlayer = require("cfmj_userPlayer_data");
...
var baseDeskInfo = cc.Class({
    ...
    initLocalData: function () {
        ...
        //桌布
        var json = cc.sys.localStorage.getItem('cfmj_zhuobu_set_' + cc.dd.user.id);
        if (json) {
            var sprite = null;
            ...
            if (sprite) {
                ...
                cc.sys.localStorage.setItem('cfmj_zhuobu_set_' + cc.dd.user.id, this.zhuomianImg[0]._name);
            }
        }
        else {
            this.deskImage.spriteFrame = this.zhuomianImg[0];
    ...
    initZhiNan: function () {
        if (this.zhinan.active && DeskData.Instance().zhiNan_site != null) {
            ...
            this.zhinan.getComponent("cfmj_zhinan_ui").initsetZhiNan(site);
    ...
    recoverDesk: function () {
        cc.log("cfmj 朋 友 recover_desk------ 接收1");
        cc.log("------恢复桌子------py");
        this.updateDesk();
        DeskData.Instance().enterSceneRecoverDesk(this.sendReadyOK.bind(this));
        if (this.fenzhang) {
    ...
    sendReadyOK: function () {
        ...
        var msg = new cc.pb.chifengmj.chifeng_req_reloading_ok();
        cc.gateNet.Instance().sendMsg(cc.netCmd.chifengmj.cmd_chifeng_req_reloading_ok, msg, "chifeng_req_reloading_ok");
        this.initGuiZeInfo();
    },
    ...
    jiesuan: function (data) {
        ...
        this.jiesuan_TimeID = this.scheduleOnce(function () {
            ...
            if (cc.director.getScene().name == 'cfmj_py_game' ||
                cc.director.getScene().name == 'cfmj_jbc_game') {
                cc.dd.UIMgr.destroyUI(jlmj_prefab.JLMJ_JIAOPAI_INFO);
    ...
    leave_tips: function (data) {
        ...
        if (DeskData.Instance().isFriend()) {//朋友场
            ...
            } else if (cfmj_desk_data_jbc.getInstance().getIsMatching() || DeskData.Instance().player_read_gamne) {//取消匹配状态
                txt = Text.TEXT_LEAVE_ROOM_3;
                callfunc = this.jbc_matching_leave_room_req;
            } else if (cfmj_desk_data_jbc.getInstance().getIsStart()) {//游戏中退出游戏
    ...
    py_dissolve_room_req: function () {
        ...
        var msg = new cc.pb.chifengmj.chifeng_req_sponsor_dissolve_room();
        msg.setSponsorid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.chifengmj.cmd_chifeng_req_sponsor_dissolve_room, msg, "chifeng_req_sponsor_dissolve_room");
    },
        ...
        if (msg.retCode !== 0) {
            ...
            switch (msg.retCode) {
                case 1:
                    ...
                    this.popupEnterHall(str, cfmj_util.enterHall.bind(cfmj_util));
                    break;
                case 2:
    ...
    py_ready: function () {
        ...
        var msg = new cc.pb.chifengmj.chifeng_req_ready();
        cc.gateNet.Instance().sendMsg(cc.netCmd.chifengmj.cmd_chifeng_req_ready, msg, "chifeng_req_ready");
    ...
    update_player_info: function () {
        ...
        this.zhinan.getComponent("cfmj_zhinan_ui").initDirection();
        var play_list = cc.find('Canvas/player_list').getComponent('cfmj_player_list');
    ...
    getTextByWanFa: function () {
        ...
        this.gz_arr_box = [];
        this.gz_arr_box.push(Text.TEXT_PY_RULE_138.format([cur_rule.usercountlimit]));
    ...
    onInvaite: function (event, custom) {
        ...
        jlmj_audio_mgr.com_btn_click();
        var title = Text.TEXT_PY_RULE_138.format(playerMgr.Instance().playerList.length);
    ...
    on_show_result_view: function () {
        ...
        cc.dd.UIMgr.openUI(jlmj_prefab.MJ_ZHANJITONGJI, function (ui) {
            ...
            // fj_arr.push(Text.TEXT_PY_RULE_120.format([RoomMgr.Instance()._Rule.usercountlimit]));
    ...
    onEventMessage: function (event, data) {
        ...
        switch (event) {
            ...
            case HallCommonEvent.HALL_NO_RECONNECT_GAME:
                cc.log("cfmj  响应------> HallCommonEvent.HALL_NO_RECONNECT_GAME");
            ...
            case DeskEvent.RECOVER_DESK://恢复桌子
                cc.log("cfmj 朋 友 recover_desk------ 开始0");
                this.recoverDesk();
                break;
    ...
    onClickRunScore(event, data) {
        ...
        var msg = new cc.pb.chifengmj.chifeng_req_paofen();
        msg.setScore(Number(data));
        cc.gateNet.Instance().sendMsg(cc.netCmd.chifengmj.cmd_chifeng_req_paofen, msg, "chifeng_req_paofen", true);
