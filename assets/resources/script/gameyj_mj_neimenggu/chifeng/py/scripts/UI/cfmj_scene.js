...
cc.Class({
     ...
     */
    initDlGame: function () {
        var logonode = cc.find('c-logo-chifeng', this.node).getComponent(cc.Sprite);
    ...
    playerHideModePai: function () {
        var jlmj_player_list = cc.find("Canvas/player_list").getComponent('cfmj_player_list');
    ...
    jlmjPlayerDownSortShouPai: function () {
        ...
        let jlmj_player_list = cc.find("Canvas/player_list").getComponent('cfmj_player_list');
