...
var hupai_type = require("cfmj_game_menu").hupai_type;

var menu_type = require("cfmj_game_menu").menu_type;
...
cc.Class({
    ...
    addMenu: function (type) {
        ...
        var menu = menu_node.getComponent("cfmj_game_menu");
        if(!menu){
            cc.error("cfmj_game_menu预制没有挂在cfmj_game_menu组件");
            return;
        }
        menu.type = type;
