...
var PlayerMgr = cc.Class({
    ...
    updatePlayerNum: function (num) {
        ...
        UserPlayer.clear();
        cc.log("清空玩家列表 初始化");
        if(RoomMgr.Instance().gameId == cc.dd.Define.GameType.CFMJ_FRIEND){    //朋友场
    ...
    requireDeskData:function(){
        this.DeskED = require('cfmj_desk_data').DeskED;
        this.DeskEvent = require('cfmj_desk_data').DeskEvent;
    },
});
