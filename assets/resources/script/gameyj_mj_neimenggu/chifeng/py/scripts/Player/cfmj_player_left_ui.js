...
cc.Class({
    ...
    onLoad: function () {
        cc.log('cfmj_player_left_ui onLoad');
        this.zhanshi_pai = cc.find("Canvas/desk_node/zhanshi_pais/jlmj_zhanshi_pai_left").getComponent('nmmj_pai');     //展示牌
        ...
        this.chi_ani = cc.find("Canvas/desk_node/play_anis/left/chi").getComponent(sp.Skeleton);
        this.gang_ani = cc.find("Canvas/desk_node/play_anis/left/gang").getComponent(sp.Skeleton);
        ...
        this.hu_ani = cc.find("Canvas/desk_node/play_anis/left/hu").getComponent(sp.Skeleton);
        this.peng_ani = cc.find("Canvas/desk_node/play_anis/left/peng").getComponent(sp.Skeleton);
        ...
        this.guo_ani = cc.find("Canvas/desk_node/play_anis/left/guo").getComponent(sp.Skeleton);
        ...
        this.playerLocation = cc.find("Canvas/desk_node/beforeGame/left");
        this.playerLocation.active = false;

        this.huEffect = cc.find("Canvas/huEffect/left");
