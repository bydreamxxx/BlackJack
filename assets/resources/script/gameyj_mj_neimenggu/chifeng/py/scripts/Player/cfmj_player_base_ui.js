...
cc.Class({
    ...
    properties: {
        head: { default: null, type: require("cfmj_playerHead"), tooltip: '头像', override: true },              //头像
    },
    ...
    play_chupai_ani_old: function (player, chupai_idx_in_shoupai, last_chupai_idx, cardID) {
        ...
        var zsp_spa = cc.spawn(cc.scaleTo(0.01, 1, 1), cc.moveTo(0.01, target_pos[player.viewIdx - 1]));
