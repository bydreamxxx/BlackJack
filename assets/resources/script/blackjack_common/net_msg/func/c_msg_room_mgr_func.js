    ...
    var recvFuncs = {
        ...
        [3275]:{ package_name:'msg', msg_name:'teenpatti_rule_info', name:msg.teenpatti_rule_info, func:handler.on_teenpatti_rule_info, func_name:'on_teenpatti_rule_info', logtag:'[3275:teenpatti_rule_info]' },
        [3276]:{ package_name:'msg', msg_name:'msg_get_room_user_info_req', name:msg.msg_get_room_user_info_req, func:handler.on_msg_get_room_user_info_req, func_name:'on_msg_get_room_user_info_req', logtag:'[3276:msg_get_room_user_info_req]' },
        [3277]:{ package_name:'msg', msg_name:'msg_get_room_user_info_ret', name:msg.msg_get_room_user_info_ret, func:handler.on_msg_get_room_user_info_ret, func_name:'on_msg_get_room_user_info_ret', logtag:'[3277:msg_get_room_user_info_ret]' },
        [3278]:{ package_name:'msg', msg_name:'room_user_info', name:msg.room_user_info, func:handler.on_room_user_info, func_name:'on_room_user_info', logtag:'[3278:room_user_info]' },
        [3279]:{ package_name:'msg', msg_name:'msg_get_room_self_build_req', name:msg.msg_get_room_self_build_req, func:handler.on_msg_get_room_self_build_req, func_name:'on_msg_get_room_self_build_req', logtag:'[3279:msg_get_room_self_build_req]' },
        [3280]:{ package_name:'msg', msg_name:'room_self_build_info', name:msg.room_self_build_info, func:handler.on_room_self_build_info, func_name:'on_room_self_build_info', logtag:'[3280:room_self_build_info]' },
        [3281]:{ package_name:'msg', msg_name:'msg_get_room_self_build_ret', name:msg.msg_get_room_self_build_ret, func:handler.on_msg_get_room_self_build_ret, func_name:'on_msg_get_room_self_build_ret', logtag:'[3281:msg_get_room_self_build_ret]' },
        [3282]:{ package_name:'msg', msg_name:'msg_check_room_info_req', name:msg.msg_check_room_info_req, func:handler.on_msg_check_room_info_req, func_name:'on_msg_check_room_info_req', logtag:'[3282:msg_check_room_info_req]' },
        [3283]:{ package_name:'msg', msg_name:'msg_check_room_info_ret', name:msg.msg_check_room_info_ret, func:handler.on_msg_check_room_info_ret, func_name:'on_msg_check_room_info_ret', logtag:'[3283:msg_check_room_info_ret]' },
        [3284]:{ package_name:'msg', msg_name:'xl_game_rule_public', name:msg.xl_game_rule_public, func:handler.on_xl_game_rule_public, func_name:'on_xl_game_rule_public', logtag:'[3284:xl_game_rule_public ]' },
        [3285]:{ package_name:'msg', msg_name:'msg_friend_create_room_req', name:msg.msg_friend_create_room_req, func:handler.on_msg_friend_create_room_req, func_name:'on_msg_friend_create_room_req', logtag:'[3285:msg_friend_create_room_req ]' },
        [3286]:{ package_name:'msg', msg_name:'friend_room', name:msg.friend_room, func:handler.on_friend_room, func_name:'on_friend_room', logtag:'[3286:friend_room]' },
        [3287]:{ package_name:'msg', msg_name:'msg_friend_create_room_ret', name:msg.msg_friend_create_room_ret, func:handler.on_msg_friend_create_room_ret, func_name:'on_msg_friend_create_room_ret', logtag:'[3287:msg_friend_create_room_ret ]' },
        [3288]:{ package_name:'msg', msg_name:'coin_result_item', name:msg.coin_result_item, func:handler.on_coin_result_item, func_name:'on_coin_result_item', logtag:'[3288:coin_result_item ]' },
        [3289]:{ package_name:'msg', msg_name:'g2h_sync_room_round', name:msg.g2h_sync_room_round, func:handler.on_g2h_sync_room_round, func_name:'on_g2h_sync_room_round', logtag:'[3289:g2h_sync_room_round]' },
        [3290]:{ package_name:'msg', msg_name:'jisu_req_createdesk', name:msg.jisu_req_createdesk, func:handler.on_jisu_req_createdesk, func_name:'on_jisu_req_createdesk', logtag:'[3290:jisu_req_createdesk]' },
