    ...
    var recvFuncs = {
        ...
        [9805]:{ package_name:'msg', msg_name:'msg_rm_poker_req', name:msg.msg_rm_poker_req, func:handler.on_msg_rm_poker_req, func_name:'on_msg_rm_poker_req', logtag:'[9805:msg_rm_poker_req]' },
        [9806]:{ package_name:'msg', msg_name:'msg_rm_poker_ack', name:msg.msg_rm_poker_ack, func:handler.on_msg_rm_poker_ack, func_name:'on_msg_rm_poker_ack', logtag:'[9806:msg_rm_poker_ack]' },
        [9807]:{ package_name:'msg', msg_name:'msg_rm_deal_poker', name:msg.msg_rm_deal_poker, func:handler.on_msg_rm_deal_poker, func_name:'on_msg_rm_deal_poker', logtag:'[9807:msg_rm_deal_poker]' },
        [9808]:{ package_name:'msg', msg_name:'msg_rm_deal_poker_broadcast', name:msg.msg_rm_deal_poker_broadcast, func:handler.on_msg_rm_deal_poker_broadcast, func_name:'on_msg_rm_deal_poker_broadcast', logtag:'[9808:msg_rm_deal_poker_broadcast]' },
        [9809]:{ package_name:'msg', msg_name:'msg_rm_give_up_poker_req', name:msg.msg_rm_give_up_poker_req, func:handler.on_msg_rm_give_up_poker_req, func_name:'on_msg_rm_give_up_poker_req', logtag:'[9809:msg_rm_give_up_poker_req]' },
        [9810]:{ package_name:'msg', msg_name:'msg_rm_give_up_poker_ack', name:msg.msg_rm_give_up_poker_ack, func:handler.on_msg_rm_give_up_poker_ack, func_name:'on_msg_rm_give_up_poker_ack', logtag:'[9810:msg_rm_give_up_poker_ack]' },
        [9811]:{ package_name:'msg', msg_name:'msg_rm_give_up_poker_broadcast', name:msg.msg_rm_give_up_poker_broadcast, func:handler.on_msg_rm_give_up_poker_broadcast, func_name:'on_msg_rm_give_up_poker_broadcast', logtag:'[9811:msg_rm_give_up_poker_broadcast]' },
        [9812]:{ package_name:'msg', msg_name:'msg_rm_syn_giveup_poker', name:msg.msg_rm_syn_giveup_poker, func:handler.on_msg_rm_syn_giveup_poker, func_name:'on_msg_rm_syn_giveup_poker', logtag:'[9812:msg_rm_syn_giveup_poker]' },
