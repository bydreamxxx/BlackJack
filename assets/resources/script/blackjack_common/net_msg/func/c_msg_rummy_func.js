    ...
    var recvFuncs = {
        ...
        [9819]:{ package_name:'msg', msg_name:'msg_rm_group_req', name:msg.msg_rm_group_req, func:handler.on_msg_rm_group_req, func_name:'on_msg_rm_group_req', logtag:'[9819:msg_rm_group_req]' },
        [9820]:{ package_name:'msg', msg_name:'msg_rm_group_ack', name:msg.msg_rm_group_ack, func:handler.on_msg_rm_group_ack, func_name:'on_msg_rm_group_ack', logtag:'[9820:msg_rm_group_ack]' },
        [9821]:{ package_name:'msg', msg_name:'msg_rm_sort_req', name:msg.msg_rm_sort_req, func:handler.on_msg_rm_sort_req, func_name:'on_msg_rm_sort_req', logtag:'[9821:msg_rm_sort_req]' },
        [9822]:{ package_name:'msg', msg_name:'msg_rm_sort_ack', name:msg.msg_rm_sort_ack, func:handler.on_msg_rm_sort_ack, func_name:'on_msg_rm_sort_ack', logtag:'[9822:msg_rm_sort_ack]' },
        [9823]:{ package_name:'msg', msg_name:'msg_rm_drop_req', name:msg.msg_rm_drop_req, func:handler.on_msg_rm_drop_req, func_name:'on_msg_rm_drop_req', logtag:'[9823:msg_rm_drop_req]' },
        [9824]:{ package_name:'msg', msg_name:'msg_rm_drop_ack', name:msg.msg_rm_drop_ack, func:handler.on_msg_rm_drop_ack, func_name:'on_msg_rm_drop_ack', logtag:'[9824:msg_rm_drop_ack]' },
        [9825]:{ package_name:'msg', msg_name:'msg_drop_score', name:msg.msg_drop_score, func:handler.on_msg_drop_score, func_name:'on_msg_drop_score', logtag:'[9825:msg_drop_score]' },
        [9826]:{ package_name:'msg', msg_name:'rm_result_info', name:msg.rm_result_info, func:handler.on_rm_result_info, func_name:'on_rm_result_info', logtag:'[9826:rm_result_info]' },
        [9827]:{ package_name:'msg', msg_name:'msg_rm_result', name:msg.msg_rm_result, func:handler.on_msg_rm_result, func_name:'on_msg_rm_result', logtag:'[9827:msg_rm_result]' },
        [9828]:{ package_name:'msg', msg_name:'rm_tips_req', name:msg.rm_tips_req, func:handler.on_rm_tips_req, func_name:'on_rm_tips_req', logtag:'[9828:rm_tips_req]' },
        [9829]:{ package_name:'msg', msg_name:'rm_tips_ack', name:msg.rm_tips_ack, func:handler.on_rm_tips_ack, func_name:'on_rm_tips_ack', logtag:'[9829:rm_tips_ack]' },
