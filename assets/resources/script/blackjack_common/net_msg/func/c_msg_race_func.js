    ...
    const msg = {};
    var handler = require('net_handler_race');
    var recvFuncs = {
        ...
        [3303]:{ package_name:'msg', msg_name:'msg_match_race_reward', name:msg.msg_match_race_reward, func:handler.on_msg_match_race_reward, func_name:'on_msg_match_race_reward', logtag:'[3303:msg_match_race_reward ]' },
