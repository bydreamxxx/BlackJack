...
cc.Class({
    ...
    spawnEmoji(name, id) {
        ...
        let emo_db_node = cc.instantiate(this.emoji_ani_node[id - 1]);// text.color = this.randomColor();
        emo_db_node.parent = this.node;
        emo_db_node.active = true;
        emo_db_node.getComponent(cc.Animation).play();
