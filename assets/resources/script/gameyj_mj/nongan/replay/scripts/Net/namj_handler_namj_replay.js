...
var handler = cc.Class({
    extends: namj_net_handler_namj.constructor,

    ctor: function() {
        cc.log( "namj_net_handler_namj 子类 回放" );
    },
    ...
    on_na_ack_roomInit: function( msg ) {
        ...
        if(!cc.replay_gamedata_scrolling){
            ...
            if(play_list){
                play_list.getComponent('namj_player_list').playerUpdateShouPaiUI();
            }
        }
    },
    ...
    on_na_ack_game_overturn: function( msg ) {
        ...
        if(!cc.replay_gamedata_scrolling){
            ...
            if(player.isUserPlayer()){
                ...
                var menu_list = cc.find("Canvas/game_menu_list_"+player.viewIdx).getComponent("namj_game_menu_list");
            }
            var menu_pos = [
                [
                    cc.v2(472, -134),
