...
var ccjb_handler = cc.Class({
    ...
    ctor: function () {
        cc.log("namj_net_handler_namj 子类");
    },
    ...
    on_na_ack_send_current_result: function( msg ) {
        this._super(msg);
        namj_desk_data_jbc.getInstance().setIsStart(DeskData.Instance().isFriend()==false);
    ...
    on_na_ack_reconnect: function( msg ) {
        ...
        namj_desk_data_jbc.getInstance().setIsReconnect( true );
        namj_desk_data_jbc.getInstance().setIsStart( true );
        DeskData.Instance().setIsStart( true );
        ...
        namj_desk_data_jbc.getInstance().setData( jlmjJbcCfgItem );
     ...
     * @param msg
     */
    on_na_ack_update_coin: function( msg ) {
