...
var PlayerData = require("namj_player_data").PlayerData;
...
var NAMJUserPlayerData = cc.Class({
    ...
    statics: {
        ...
        Instance: function () {
            if(!this.s_userPlayer){
                this.s_userPlayer = new NAMJUserPlayerData();
            }
        ...
        if(this.cangang || this.canbugang){
            if(!DeskData.Instance().hasRemainPai()){
                ...
                if( gangOption.cardList.length == 1 ) {
                    ...
                    //const gang_Analysts = require('namj_pai_analysts');
    ...
    setDapaiTing:function (msg) {
        if(!msg.jiaoinfosList.length || msg.cangu){
            return;
        }
        this.jiaoInfo_list = [];
        var list = [];
...
module.exports = NAMJUserPlayerData;
