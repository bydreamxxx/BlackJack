...
var PlayerMgr = cc.Class({
    ...
    updatePlayerNum: function (num) {
        ...
        UserPlayer.clear();
        cc.log("清空玩家列表 初始化");
        if(RoomMgr.Instance().gameId == cc.dd.Define.GameType.NAMJ_FRIEND){    //朋友场
    ...
    playerEnter: function (role_info) {
        ...
        if(RoomMgr.gameId==cc.dd.Define.GameType.NAMJ_FRIEND){
    ...
    requireDeskData:function(){
        this.DeskED = require('namj_desk_data').DeskED;
        this.DeskEvent = require('namj_desk_data').DeskEvent;
    },
});
