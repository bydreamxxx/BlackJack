...
var PlayerHead = cc.Class({
    ...
    onLoad: function () {
        ...
        //头像
        this.head = cc.find('headNode/head', this.node).getComponent(cc.Sprite);
        //离线
        this.offline = cc.find('headNode/offlline', this.node);
        //vip节点
        this.vip_node = cc.find('vip_head', this.node);
        //vip级别
        this.vip_lv = cc.find('vip_head/level', this.node).getComponent(cc.Label);
        //网络信号
        this.net_signal = cc.find('weak', this.node);
        //GPS警报
        ...
        //魔法道具
        this.magic_prop = cc.find('Canvas/desk_node/com_magic_prop');
