...
var namj_Control_Combination_ui = require( "namj_Control_Combination_ui" );
...
var cc_GameMenu = cc.Class({
     ...
     */
    guo: function () {
        var msg = new cc.pb.nonganmajiang.na_req_game_act_guo();
        msg.setUserid(dd.user.id);
        msg.setGuotype(this.getGuoType());
        cc.gateNet.Instance().sendMsg(cc.netCmd.nonganmajiang.cmd_na_req_game_act_guo,msg,"na_req_game_act_guo");
    },
    ...
    chi: function () {
        ...
        if(UserPlayer.chi_options.length == 1){
            //只有一个吃，直接吃
            var msg = new cc.pb.nonganmajiang.na_req_chi();
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.nonganmajiang.cmd_na_req_chi,msg,"na_req_chi");
    ...
    peng: function () {
        ...
        var msg = new cc.pb.nonganmajiang.na_req_game_act_peng();
        msg.setUserid(dd.user.id);

        var pengCard = new cc.pb.jilinmajiang.CardInfo();
        pengCard.setId(DeskData.Instance().last_chupai_id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.nonganmajiang.cmd_na_req_game_act_peng,msg,"na_req_game_act_peng");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    onSeclectedGang: function ( selectedList ) {
        ...
        namj_Control_Combination_ui.Instance().onCloseCombinationUi();
    },
    ...
    gang: function () {
        ...
        if( gangOption.cardList.length == 1 ) {
            ...
            if( isGangTing ) {
                ...
                namj_Control_Combination_ui.Instance().getAllCombinationList( gangOptionList1, gangOptionList,true);

            } else {
                namj_Control_Combination_ui.Instance().getAllCombinationList( gangOption.cardList, gangOptionList,false);
            }
    ...
    ting: function () {
        ...
        msg.setCardid(-1);
        msg.setTingtype(1);
        cc.gateNet.Instance().sendMsg(cc.netCmd.nonganmajiang.cmd_na_req_tingpai_out_card,msg,"na_req_tingpai_out_card");
    },
     ...
     */
    hupai: function () {
        var msg = new cc.pb.nonganmajiang.na_req_game_act_hu();
        msg.setUserid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.nonganmajiang.cmd_na_req_game_act_hu,msg,"na_req_game_act_hu");
    },
    ...
    gu: function () {
        ...
        PlayerED.notifyEvent(PlayerEvent.SHOW_GU_PAI,[UserPlayer, true, arr, 5]);    //设置可点击的牌
    },
    ...
    sendGangPai:function (gang_option) {
        var msg = new cc.pb.nonganmajiang.na_req_game_act_gang();
        ...
        cc.gateNet.Instance().sendMsg(cc.netCmd.nonganmajiang.cmd_na_req_game_act_gang,msg,"na_req_game_act_gang");
        cc.dd.NetWaitUtil.net_wait_start();
    },
