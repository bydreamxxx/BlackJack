...
var ccmj_Control_Combination_ui = require( "ccmj_Control_Combination_ui" );
...
var cc_GameMenu = cc.Class({
     ...
     */
    guo: function () {
        var msg = new cc.pb.changchunmajiang.p16_req_game_act_guo();
        msg.setUserid(dd.user.id);
        msg.setGuotype(this.getGuoType());
        cc.gateNet.Instance().sendMsg(cc.netCmd.changchunmajiang.cmd_p16_req_game_act_guo,msg,"p16_req_game_act_guo");
    },
    ...
    chi: function () {
        ...
        if(UserPlayer.chi_options.length == 1){
            //只有一个吃，直接吃
            var msg = new cc.pb.changchunmajiang.p16_req_chi();
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.changchunmajiang.cmd_p16_req_chi,msg,"p16_req_chi");
    ...
    peng: function () {
        ...
        var msg = new cc.pb.changchunmajiang.p16_req_game_act_peng();
        msg.setUserid(dd.user.id);

        var pengCard = new cc.pb.jilinmajiang.CardInfo();
        pengCard.setId(DeskData.Instance().last_chupai_id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.changchunmajiang.cmd_p16_req_game_act_peng,msg,"p16_req_game_act_peng");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    onSeclectedGang: function ( selectedList ) {
        ...
        ccmj_Control_Combination_ui.Instance().onCloseCombinationUi();
    },
    ...
    gang: function () {
        ...
        if( gangOption.cardList.length == 1 ) {
            ...
            if( isGangTing ) {
                ...
                ccmj_Control_Combination_ui.Instance().getAllCombinationList( gangOptionList1, gangOptionList,true);

            } else {
                ccmj_Control_Combination_ui.Instance().getAllCombinationList( gangOption.cardList, gangOptionList,false);
            }
    ...
    ting: function () {
        ...
        //
        //
        // var msg = new cc.pb.changchunmajiang.p16_req_tingpai_out_card();
        // msg.setCardid(-1);
        // msg.setTingtype(1);
        // cc.gateNet.Instance().sendMsg(cc.netCmd.changchunmajiang.cmd_p16_req_tingpai_out_card,msg,"p16_req_tingpai_out_card");
     ...
     */
    hupai: function () {
        var msg = new cc.pb.changchunmajiang.p16_req_game_act_hu();
        msg.setUserid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.changchunmajiang.cmd_p16_req_game_act_hu,msg,"p16_req_game_act_hu");
    },
    /**
     * 取消按钮回调
     */
    ...
    sendGangPai:function (gang_option) {
        var msg = new cc.pb.changchunmajiang.p16_req_game_act_gang();
        ...
        cc.gateNet.Instance().sendMsg(cc.netCmd.changchunmajiang.cmd_p16_req_game_act_gang,msg,"p16_req_game_act_gang");
        cc.dd.NetWaitUtil.net_wait_start();
    },
