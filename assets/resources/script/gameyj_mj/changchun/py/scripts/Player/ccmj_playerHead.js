...
var PlayerHead = cc.Class({
    ...
    onLoad: function () {
        ...
        this.tuo_guan = cc.find('head_node/tuo_guan', this.node);
    ...
    playMagicProp: function (idx, fromId, toId) {
        ...
        let heads = cc.find("Canvas").getComponentsInChildren("ccmj_playerHead");
    ...
    setPoChan: function (isshow) {
        ...
        if (RoomMgr.gameId != cc.dd.Define.GameType.CCMJ_FRIEND) {
    ...
    play_chupai_ani: function (dapaiCD) {
        var maxCD = parseInt(RoomMgr.Instance()._Rule.islixiantuoguan);
        if (maxCD == 0 || !cc.dd._.isNumber(maxCD)) {
            maxCD = 30;
        }
