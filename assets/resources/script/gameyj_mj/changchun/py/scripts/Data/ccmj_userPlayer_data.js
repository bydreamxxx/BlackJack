...
var PlayerData = require("ccmj_player_data").PlayerData;
...
var CCMJUserPlayerData = cc.Class({
    ...
    statics: {
        ...
        Instance: function () {
            if(!this.s_userPlayer){
                this.s_userPlayer = new CCMJUserPlayerData();
            }
        ...
        if(this.cangang || this.canbugang){
            if(!DeskData.Instance().hasRemainPai()){
                ...
                if( gangOption.cardList.length == 1 ) {
                    ...
                    const gang_Analysts = require('ccmj_pai_analysts');
...
module.exports = CCMJUserPlayerData;
