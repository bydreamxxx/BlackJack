...
var JieSanData = require('ccmj_jiesan_data').JieSanData.Instance();
...
var CCMJDeskData = cc.Class({
    ...
    isFriend: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.CCMJ_FRIEND;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.CCMJ_FRIEND];
        return g_id && c_name;
    },

    isReplay: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.CCMJ_FRIEND;
        var c_name = cc.dd.SceneManager.getCurrScene().name=='ccmj_replay_game';
        return g_id && c_name;
    },

    isJBC: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.CCMJ_GOLD;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.CCMJ_GOLD];
        return g_id && c_name;
    },

    isMatch: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.CCMJ_MATCH;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.CCMJ_MATCH];
        return g_id && c_name;
    },

    isInMaJiang: function () {
        let scenename = cc.dd.SceneManager.getCurrScene().name;
        if(scenename == cc.dd.Define.GameId[cc.dd.Define.GameType.CCMJ_GOLD] || scenename == cc.dd.Define.GameId[cc.dd.Define.GameType.CCMJ_FRIEND] || scenename == 'ccmj_replay_game' || cc.dd.Define.GameId[cc.dd.Define.GameType.CCMJ_MATCH]){
            return true
        }else{
            return false;
        }
