...
cc.Class({
    ...
    properties: {
        head: { default: null, type: require("tdhmj_playerHead"), tooltip: '头像', override: true },              //头像
    },
    ...
    hu: function (player, isZiMo) {
        ...
        huInfoList.push({ type: HuType.PING_HU, ani: ['hu', 'huXS'], audio: ['dianpao1', 'hu1', 'hu2', 'hu3'] });           //平胡
        huInfoList.push({ type: HuType.JIA_HU, ani: ['jiahu', 'jiahuXS'], audio: ['jiahu1', 'jiahu2'] });         //夹胡
        huInfoList.push({ type: HuType.BIAN_HU, ani: ['bianhu', 'bianhuXS'], audio: ['hu1', 'hu2', 'hu3'] });        //边胡
        huInfoList.push({ type: HuType.QING_YI_SE, ani: ['qingyise'], audio: ['qingyise1', 'qingyise2'] });     //清一色
        huInfoList.push({ type: HuType.PIAO_HU, ani: ['animation'], audio: 'piaohu' });        //飘胡
        huInfoList.push({ type: HuType.QI_DUI, ani: ['hu', 'huXS'], audio: '7dui' });         //七对
        huInfoList.push({ type: HuType.HAO_QI, ani: ['hu', 'huXS'], audio: 'hh7dui' });         //豪七
        huInfoList.push({ type: HuType.ZHIZUN_HAO_QI, ani: ['hu', 'huXS'], audio: 'hh7dui' });         //至尊豪七
        huInfoList.push({ type: HuType.GANG_HUA_HU, ani: ['hu', 'huXS'], audio: 'gangkai' });          //杠上花
        huInfoList.push({ type: HuType.GANG_PAO_HU, ani: ['hu', 'huXS'], audio: ['hu1', 'hu2', 'hu3'] });          //杠上炮
        huInfoList.push({ type: HuType.ZI_MO, ani: ['zimo', 'zimoXS'], audio: ['zimo1', 'zimo2'] });          //自摸
        huInfoList.push({ type: HuType.HAIDI_LAO, ani: ['hu', 'huXS'], audio: ['hu1', 'hu2', 'hu3'] });          //一条龙




        var zimoHuList = [];
        zimoHuList.push({ type: HuType.ZI_MO, ani: ['zimo', 'zimoXS'], audio: ['zimo1', 'zimo2'] });          //自摸
        zimoHuList.push({ type: HuType.QING_YI_SE, ani: ['qingyise'], audio: ['qingyise1', 'qingyise2'] });     //清一色
        zimoHuList.push({ type: HuType.PIAO_HU, ani: ['animation'], audio: 'piaohu' });        //飘胡
        zimoHuList.push({ type: HuType.QI_DUI, ani: ['zimo', 'zimoXS'], audio: '7dui' });
        zimoHuList.push({ type: HuType.HAO_QI, ani: ['zimo', 'zimoXS'], audio: 'hh7dui' });         //豪七
        zimoHuList.push({ type: HuType.ZHIZUN_HAO_QI, ani: ['zimo', 'zimoXS'], audio: 'hh7dui' });         //至尊豪七
        zimoHuList.push({ type: HuType.HAIDI_LAO, ani: ['zimo', 'zimoXS'], audio: ['zimo1', 'zimo2'] });          //一条龙
        zimoHuList.push({ type: HuType.GANG_HUA_HU, ani: ['zimo', 'zimoXS'], audio: 'gangkai' });          //杠上花
        zimoHuList.push({ type: HuType.GANG_PAO_HU, ani: ['zimo', 'zimoXS'], audio: ['zimo1', 'zimo2'] });          //杠上炮
