...
var gang_Analysts = require('tdhmj_pai_analysts');
...
var cc_ControlCombinationUi = cc.Class({
     ...
     */
    getAllCombinationList:function(cardList, groupList, isgangting, isXi){
        gang_Analysts.Instance().getAllGangGroup(cardList, groupList, isXi,isgangting);
    }
});
