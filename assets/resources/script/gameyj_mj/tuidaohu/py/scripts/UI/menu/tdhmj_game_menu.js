...
var tdhmj_Control_Combination_ui = require( "tdhmj_Control_Combination_ui" );
...
var menu_cfg = [
    ...
    { txtFrame:null, bgFrame:2,    desc:"ok" },
    { txtFrame:null, bgFrame:2,    desc:"清除" },
    { txtFrame:8,    bgFrame:0,    desc:"亮喜" },
];
...
var cc_GameMenu = cc.Class({
     ...
     */
    guo: function () {
        var msg = new cc.pb.neimenggumj.neimenggu_req_game_act_guo();
        msg.setUserid(dd.user.id);
        msg.setGuotype(this.getGuoType());
        cc.gateNet.Instance().sendMsg(cc.netCmd.neimenggumj.cmd_neimenggu_req_game_act_guo,msg,"neimenggu_req_game_act_guo");
    },
    ...
    chi: function () {
        ...
        if(UserPlayer.chi_options.length == 1){
            //只有一个吃，直接吃
            var msg = new cc.pb.neimenggumj.neimenggu_req_chi();
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.neimenggumj.cmd_neimenggu_req_chi,msg,"neimenggu_req_chi");
    ...
    peng: function () {
        ...
        var msg = new cc.pb.neimenggumj.neimenggu_req_game_act_peng();
        msg.setUserid(dd.user.id);

        var pengCard = new cc.pb.jilinmajiang.CardInfo();
        pengCard.setId(DeskData.Instance().last_chupai_id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.neimenggumj.cmd_neimenggu_req_game_act_peng,msg,"neimenggu_req_game_act_peng");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    onSeclectedGang: function ( selectedList ) {
        ...
        tdhmj_Control_Combination_ui.Instance().onCloseCombinationUi();
    },
     ...
     * @param selectedList
     */
    onSeclectedXi: function ( selectedList ) {
        var gangOption = UserPlayer.xiList;
        gangOption.cardList = selectedList;
        this.sendGangPai( gangOption );
        this.interactable = true;
        tdhmj_Control_Combination_ui.Instance().onCloseCombinationUi();
    ...
    gang: function () {
        ...
        if( gangOption.cardList.length == 1 ) {
            ...
            if( isGangTing ) {
                ...
                tdhmj_Control_Combination_ui.Instance().getAllCombinationList( gangOptionList1, gangOptionList,true);

            } else {
                tdhmj_Control_Combination_ui.Instance().getAllCombinationList( gangOption.cardList, gangOptionList,false);
            }
    ...
    ting: function () {
        ...
        // msg.setCardid(-1);
        // msg.setTingtype(1);
        // cc.gateNet.Instance().sendMsg(cc.netCmd.neimenggumj.cmd_neimenggu_req_tingpai_out_card,msg,"neimenggu_req_tingpai_out_card");
     ...
     */
    hupai: function () {
        var msg = new cc.pb.neimenggumj.neimenggu_req_game_act_hu();
        msg.setUserid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.neimenggumj.cmd_neimenggu_req_game_act_hu,msg,"neimenggu_req_game_act_hu");
    ...
    sendGangPai:function (gang_option) {
        var msg = new cc.pb.neimenggumj.neimenggu_req_game_act_gang();
        ...
        cc.gateNet.Instance().sendMsg(cc.netCmd.neimenggumj.cmd_neimenggu_req_game_act_gang,msg,"neimenggu_req_game_act_gang");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    liangxi: function(){
        var gangOption = UserPlayer.xiList;
        let gang_option = {cardList:[], isnewdealstyle: gangOption.isnewdealstyle};

        gang_option.cardList.push(gangOption.zhong.pop());
        gang_option.cardList.push(gangOption.fa.pop());
        gang_option.cardList.push(gangOption.bai.pop());
