...
var ccjb_handler = cc.Class({
    ...
    ctor: function () {
        cc.log("tdhmj_net_handler_tdhmj 子类");
    },
    ...
    on_neimenggu_ack_roomInit: function( msg ) {
        cc.log("jbc on_neimenggu_ack_roomInit");
    ...
    on_neimenggu_ack_send_current_result: function( msg ) {
        this._super(msg);
        tdhmj_desk_data_jbc.getInstance().setIsStart(DeskData.Instance().isFriend()==false);
    ...
    on_neimenggu_ack_reconnect: function( msg ) {
        ...
        if(msg.deskrules.desktype == cc.dd.Define.GameType.TDHMJ_MATCH){
            this._super(msg);
            return;
        }
        ...
        tdhmj_desk_data_jbc.getInstance().setIsReconnect( true );
        tdhmj_desk_data_jbc.getInstance().setIsStart( true );
        DeskData.Instance().setIsStart( true );
        ...
        tdhmj_desk_data_jbc.getInstance().setData( jlmjJbcCfgItem );
