...
var jzmj_Control_Combination_ui = require( "jzmj_Control_Combination_ui" );
...
var cc_GameMenu = cc.Class({
     ...
     */
    guo: function () {
        var msg = new cc.pb.jinzhoumj.jinzhou_req_game_act_guo();
        msg.setUserid(dd.user.id);
        msg.setGuotype(this.getGuoType());
        cc.gateNet.Instance().sendMsg(cc.netCmd.jinzhoumj.cmd_jinzhou_req_game_act_guo,msg,"jinzhou_req_game_act_guo");
    },
    ...
    chi: function () {
        ...
        if(UserPlayer.chi_options.length == 1){
            //只有一个吃，直接吃
            var msg = new cc.pb.jinzhoumj.jinzhou_req_chi();
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.jinzhoumj.cmd_jinzhou_req_chi,msg,"jinzhou_req_chi");
     ...
     */
    peng: function () {
        UserPlayer.isLiangPaiPeng = false;

        var msg = new cc.pb.jinzhoumj.jinzhou_req_game_act_peng();
        msg.setUserid(dd.user.id);

        var pengCard = new cc.pb.jilinmajiang.CardInfo();
        pengCard.setId(DeskData.Instance().last_chupai_id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.jinzhoumj.cmd_jinzhou_req_game_act_peng,msg,"jinzhou_req_game_act_peng");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    onSeclectedGang: function ( selectedList ) {
        ...
        jzmj_Control_Combination_ui.Instance().onCloseCombinationUi();
    },
    ...
    gang: function () {
        ...
        if( gangOption.cardList.length == 1 ) {
            ...
            if( isGangTing ) {
                ...
                jzmj_Control_Combination_ui.Instance().getAllCombinationList( gangOptionList1, gangOptionList,true);

            } else {
                jzmj_Control_Combination_ui.Instance().getAllCombinationList( gangOption.cardList, gangOptionList,false);
            }
    ...
    ting: function () {
        ...
        // msg.setCardid(-1);
        // msg.setTingtype(1);
        // cc.gateNet.Instance().sendMsg(cc.netCmd.jinzhoumj.cmd_jinzhou_req_tingpai_out_card,msg,"jinzhou_req_tingpai_out_card");
     ...
     */
    hupai: function () {
        var msg = new cc.pb.jinzhoumj.jinzhou_req_game_act_hu();
        msg.setUserid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.jinzhoumj.cmd_jinzhou_req_game_act_hu,msg,"jinzhou_req_game_act_hu");
    },
    /**
     * 取消按钮回调
     */
    ...
    sendGangPai:function (gang_option) {
        var msg = new cc.pb.jinzhoumj.jinzhou_req_game_act_gang();
        ...
        cc.gateNet.Instance().sendMsg(cc.netCmd.jinzhoumj.cmd_jinzhou_req_game_act_gang,msg,"jinzhou_req_game_act_gang");
        cc.dd.NetWaitUtil.net_wait_start();
    },
