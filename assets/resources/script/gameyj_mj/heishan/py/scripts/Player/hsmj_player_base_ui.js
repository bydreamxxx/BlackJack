...
cc.Class({
    ...
    properties: {
        head: { default: null, type: require("hsmj_playerHead"), tooltip: '头像', override: true },              //头像
    },
    ...
    hu: function (player, isZiMo) {
        ...
        huInfoList.push({ type: HuType.QUAN_19, ani: ['hu', 'huXS'], audio: 'dianpao_hu' });           //独门胡
        ...
        huInfoList.push({ type: HuType.XIAO_SA, ani: ['ditu'], audio: 'zimo' });        //地胡



        var zimoHuList = [];
        zimoHuList.push({ type: HuType.ZI_MO, ani: ['zimo', 'zimoXS'], audio: 'zimo' });          //自摸
        zimoHuList.push({ type: HuType.QUAN_19, ani: ['zimo', 'zimoXS'], audio: 'zimo' });           //独门胡
