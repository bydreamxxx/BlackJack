...
var JieSanData = require('hsmj_jiesan_data').JieSanData.Instance();
...
var HSMJDeskData = cc.Class({
    ...
    ctor: function () {
        ...
        if(RoomMgr.Instance()._Rule){
            this.remainCards = RoomMgr.Instance()._Rule.ishavednxb ? 136 : 120;
        }
    },
    clear: function () {
        this._super();
    ...
    isFriend: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.HSMJ_FRIEND;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.HSMJ_FRIEND];
        return g_id && c_name;
    },

    isReplay: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.HSMJ_FRIEND;
        var c_name = cc.dd.SceneManager.getCurrScene().name=='hsmj_replay_game';
        return g_id && c_name;
    },

    isJBC: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.HSMJ_GOLD;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.HSMJ_GOLD];
        return g_id && c_name;
    },

    isMatch: function () {
        var g_id = RoomMgr.Instance().gameId==cc.dd.Define.GameType.HSMJ_MATCH;
        var c_name = cc.dd.SceneManager.getCurrScene().name==cc.dd.Define.GameId[cc.dd.Define.GameType.HSMJ_MATCH];
        return g_id && c_name;
    },

    isInMaJiang: function () {
        let scenename = cc.dd.SceneManager.getCurrScene().name;
        if(scenename == cc.dd.Define.GameId[cc.dd.Define.GameType.HSMJ_GOLD] || scenename == cc.dd.Define.GameId[cc.dd.Define.GameType.HSMJ_FRIEND] || scenename == 'hsmj_replay_game' || cc.dd.Define.GameId[cc.dd.Define.GameType.HSMJ_MATCH]){
            return true
        }else{
            return false;
        }
