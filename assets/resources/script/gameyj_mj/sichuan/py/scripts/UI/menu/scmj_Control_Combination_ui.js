...
var gang_Analysts = require('scmj_pai_analysts');

var jlmj_Control_Combination_ui = require( "jlmj_Control_Combination_ui" );

var sc_ControlCombinationUi = cc.Class({
    ...
    statics: {
        ...
        Instance: function () {
            if (!this.s_instance) {
                this.s_instance = new sc_ControlCombinationUi();
            }
...
module.exports = sc_ControlCombinationUi;