...
let right = cc.Class({
    ...
    resetConfig(){
        if(this.isNeimeng){
            ...
            this.pai3dCfg = require("nmmj_pai3d_right").Instance();
            let path = '';
            if(use2D){
                let pa2d = this.require_DeskData.Instance().get2DPai();
                path = '_2d_'+pa2d;
                this.pai3dCfg = require("nmmj_pai3d_right_2d_"+pa2d).Instance()
            }
            this.shou2mid_ani_path = 'gameyj_mj_neimenggu/common/animations/pai'+path+'/right/nmmj_shou2mid_right_';
    ...
    initPlayerPai: function (res_pai) {
        ...
        if(cc.find("Canvas/desk_node/right_head_button")){
    ...
    initPlayerUI() {
        ...
        cc.log('mj_player_right_ui onLoad');
    },
    ...
    getMid2DaPaiAniPath: function () {
        ...
        if(this.isNeimeng) {
            switch (this.require_playerMgr.Instance().playerList.length) {
                case 3:
                    return 'gameyj_mj_neimenggu/common/animations/pai3'+path+'/right/nmmj_mid2dapai_right_';
                case 2:
                    return 'gameyj_mj_neimenggu/common/animations/pai2'+path+'/right/nmmj_mid2dapai_right_';
                default:
                    return 'gameyj_mj_neimenggu/common/animations/pai'+path+'/right/nmmj_mid2dapai_right_';
            }
        }else{
            switch (this.require_playerMgr.Instance().playerList.length) {
                case 3:
     ...
     */
    initHuPai: function (){
        cc.log("-----------------------no implements base_mj_player_right_ui initHuPai-----------------------")
    },
     ...
     */
    clearHuPai: function (){
        cc.log("-----------------------no implements base_mj_player_right_ui clearHuPai-----------------------")
    },

    initMJComponet(){
        cc.log("-----------------------no implements base_mj_player_right_ui initMJComponet-----------------------")
