...
var fxjb_handler = cc.Class({

    extends: fxmj_net_handler_fxmj.constructor,
    ctor: function () {
        cc.log("fxmj_net_handler_fxmj 子类");
    },
    ...
    on_fx_ack_send_current_result: function( msg ) {
        this._super(msg);
        fxmj_desk_data_jbc.getInstance().setIsStart(DeskData.Instance().isFriend()==false);
    ...
    on_fx_ack_reconnect: function( msg ) {
        ...
        fxmj_desk_data_jbc.getInstance().setIsReconnect( true );
        fxmj_desk_data_jbc.getInstance().setIsStart( true );
        DeskData.Instance().setIsStart( true );
        ...
        fxmj_desk_data_jbc.getInstance().setData( jlmjJbcCfgItem );
     ...
     * @param msg
     */
    on_fx_ack_update_coin: function( msg ) {
...
module.exports = new fxjb_handler();