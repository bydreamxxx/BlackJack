...
var handler = cc.Class({
    ...
    ctor: function() {
        cc.log( "fxmj_net_handler_fxmj 子类 回放" );
    },
    ...
    on_fx_ack_roomInit: function( msg ) {
        ...
        if(!cc.replay_gamedata_scrolling){
            ...
            if(play_list){
                play_list.getComponent('fxmj_player_list').playerUpdateShouPaiUI();
            }
        }
    },
    ...
    on_fx_ack_game_overturn: function( msg ) {
        ...
        if(!cc.replay_gamedata_scrolling){
            ...
            if(player.isUserPlayer()){
                ...
                var menu_list = cc.find("Canvas/game_menu_list_"+player.viewIdx).getComponent("fxmj_game_menu_list");
            }
            var menu_pos = [
                [
                    cc.v2(472, -134),
    ...
    on_fx_ack_send_current_result: function( msg ) {
        ...
        if (DeskData.Instance().isInMaJiang()) {
            cc.dd.UIMgr.openUI(jlmj_prefab.FXMJ_JIESUAN, function (ui) {
