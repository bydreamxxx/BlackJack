...
var fxmj_Control_Combination_ui = require( "fxmj_Control_Combination_ui" );
...
var fx_GameMenu = cc.Class({
     ...
     */
    guo: function () {
        var msg = new cc.pb.fuxinmajiang.fx_req_game_act_guo();
        msg.setUserid(dd.user.id);
        msg.setGuotype(this.getGuoType());
        cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_game_act_guo,msg,"fx_req_game_act_guo");
    },
    /**
     * 过牌
     */
    ...
    chi: function () {
        ...
        if(UserPlayer.chi_options.length == 1){
            //只有一个吃，直接吃
            var msg = new cc.pb.fuxinmajiang.fx_req_chi();
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_chi,msg,"fx_req_chi");
    ...
    gangting: function () {
        ...
        this.xiaosaTingCallBack(function () {
            ...
            var msg = new cc.pb.fuxinmajiang.fx_req_gangting();
            var cards = [];
            ...
            cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_gangting, msg, "cmd_fx_req_gangting");
        });
    ...
    xiaosaTingCallBack:function (fun) {
        ...
        if(UserPlayer.isTempXiaosa == false) {
            ...
            cc.find("Canvas/game_menu_list").getComponent("fxmj_game_menu_list").setPlayerMenus(menuState);
        }
     ...
     */
    peng: function () {
        var msg = new cc.pb.fuxinmajiang.fx_req_game_act_peng();
        msg.setUserid(dd.user.id);

        var pengCard = new cc.pb.jilinmajiang.CardInfo();
        pengCard.setId(DeskData.Instance().last_chupai_id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_game_act_peng,msg,"fx_req_game_act_peng");
        cc.dd.NetWaitUtil.net_wait_start();
    },
    ...
    onSeclectedGang: function ( selectedList ) {
        ...
        fxmj_Control_Combination_ui.Instance().onCloseCombinationUi();
    },
    ...
    gang: function () {
        ...
        if( gangOption.cardList.length == 1 ) {
            ...
            if( isGangTing ) {
                ...
                fxmj_Control_Combination_ui.Instance().getAllCombinationList( gangOptionList1, gangOptionList,true);

            } else {
                fxmj_Control_Combination_ui.Instance().getAllCombinationList( gangOption.cardList, gangOptionList,false);
            }
     ...
     */
    hupai: function () {
        var msg = new cc.pb.fuxinmajiang.fx_req_game_act_hu();
        msg.setUserid(dd.user.id);
        cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_game_act_hu,msg,"fx_req_game_act_hu");
    },
    ...
    okBtnCallBack:function (data) {
        ...
        if(data.type == menu_type.TING){//听牌
            ...
            msg.setTingtype( 1 );
            cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_tingpai_out_card,msg,"fx_req_tingpai_out_card");
        }else{//杠牌
    ...
    sendGangPai:function (gang_option) {
        var msg = new cc.pb.fuxinmajiang.fx_req_game_act_gang();
        ...
        msg.setUserid(dd.user.id);
        msg.setChoosecardsList(cards);
        cc.gateNet.Instance().sendMsg(cc.netCmd.fuxinmajiang.cmd_fx_req_game_act_gang,msg,"fx_req_game_act_gang");
        cc.dd.NetWaitUtil.net_wait_start();
    },
