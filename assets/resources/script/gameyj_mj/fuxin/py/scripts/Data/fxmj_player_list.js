...
cc.Class({
    ...
    properties: {
        player_ui_arr: { default: [], type: [require('fxmj_player_base_ui')], tooltip:"玩家ui 顺序为下右上左", override: true},
    },
    initUI: function () {
    ...
    playerExit: function (player) {
        ...
        } else if( RoomMgr.Instance().gameId == cc.dd.Define.GameType.FXMJ_FRIEND ) {
            if( player.userId === cc.dd.user.id ) {
                // 返回俱乐部
                fxmj_util.enterHall();
            }
