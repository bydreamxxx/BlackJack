...
cc.Class({
    ...
    onLoad: function () {
        cc.log('fxmj_player_up_ui onLoad');
        this._super();
        this.zhanshi_pai = cc.find("Canvas/zhanshi_pais/jlmj_zhanshi_pai_up").getComponent('jlmj_pai');     //展示牌
        this.node_hu_1 = cc.find("Canvas/play_anis/jlmj_hu_ani_1_u");
        this.node_hu_2 = cc.find("Canvas/play_anis/jlmj_hu_ani_2_u");
        this.node_hu_3 = cc.find("Canvas/play_anis/jlmj_hu_ani_3_u");
        this.tcp_ani = cc.find("Canvas/play_anis/jlmj_tcp_ani_u");
        this.jbdga_ani = cc.find("Canvas/play_anis/jlmj_jbdga_ani_u");
        cc.find("Canvas/player_up_ui/com_game_head").zIndex = UIZorder.MJ_LAYER_TOP;
        this.chupai_node = cc.find("Canvas/chupai_up_node");
