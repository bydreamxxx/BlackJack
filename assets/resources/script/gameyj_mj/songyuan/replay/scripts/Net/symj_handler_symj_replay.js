...
var handler = cc.Class({
    ...
    ctor: function() {
        cc.log( "symj_net_handler_symj 子类 回放" );
    },
    ...
    on_sy_ack_roomInit: function( msg ) {
        ...
        if(!cc.replay_gamedata_scrolling){
            ...
            if(play_list){
                play_list.getComponent('symj_player_list').playerUpdateShouPaiUI();
            }
        }
    },
    ...
    on_sy_ack_game_overturn: function( msg ) {
        ...
        if(!cc.replay_gamedata_scrolling){
            ...
            if(player.isUserPlayer()){
                ...
                var menu_list = cc.find("Canvas/game_menu_list_"+player.viewIdx).getComponent("symj_game_menu_list");
            }
            var menu_pos = [
                [
                    cc.v2(472, -134),
