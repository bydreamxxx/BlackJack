...
cc.Class({
    ...
    onCreate: function (event, custom) {
        /************************游戏统计 start************************/
        cc.dd.Utils.sendClientAction(cc.dd.clientAction.SYMJ_FRIEND, cc.dd.clientAction.T_HALL.CREATE_ROOM);
        /************************游戏统计   end************************/
    ...
    sendCreateRoom: function (data, isProxy) {
        ...
        cc.sys.localStorage.setItem(cc.dd.user.id + '_symj_create', JSON.stringify(data));
    ...
    initData: function () {
        ...
        let result = cc.sys.localStorage.getItem(cc.dd.user.id + '_symj_create');
    ...
    getRules(data, isProxy){
        ...
        pbData.setIsbujiabuhu(data.wf[6]);
        pbData.setIsbutingdpbsj(data.wf[7]);
    ...
    setRoomRule(rule){
        ...
        this.m_objRuleIndex = {
            ...
            // 玩法
            wf: [_rule.is37jia, _rule.issiqing, _rule.iskuaibao, _rule.iskandb, _rule.isganghua, _rule.istongbaofb, _rule.isbujiabuhu, _rule.isbutingdpbsj],
            // 防作弊
            fzb: _rule.gps,
            //俱乐部限定
            club: _rule.gps,
