...
var PlayerHead = cc.Class({
    ...
    playMagicProp: function (idx, fromId, toId) {
        ...
        let heads = cc.find("Canvas").getComponentsInChildren("symj_playerHead");
    ...
    setPoChan: function (isshow) {
        ...
        if (RoomMgr.gameId != cc.dd.Define.GameType.SYMJ_FRIEND) {
    ...
    clear: function () {
        ...
        var RoomMgr = require("jlmj_room_mgr").RoomMgr.Instance();
        if (RoomMgr.gameId != cc.dd.Define.GameType.SYMJ_FRIEND && RoomMgr.gameId != cc.dd.Define.GameType.SYMJ_FRIEND_2) {
            this.head.spriteFrame = this.tx_img;
        }
