...
cc.Class({
    ...
    properties: {
        head: { default: null, type: require("symj_playerHead"), tooltip: '头像', override: true },              //头像
    },
    ...
    hu: function (player, isZiMo) {
        ...
        huInfoList.push({ type: HuType.KANDUI_BAO, ani: ['duibao'], audio: 'duibao' });        //对宝
        ...
        zimoHuList.push({ type: HuType.KANDUI_BAO, ani: ['duibao'], audio: 'duibao' });        //对宝
