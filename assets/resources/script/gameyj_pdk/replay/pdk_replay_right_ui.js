                ...
                switch (type) {
                    case 3://三张
                        ...
                        if (aaa && cc._replayPDKBombAAA) {
                            cc.find('Canvas/root').getComponent('pdk_replay').playBombAnimation('you');
                        }
                        break;
                    case 5://顺子
                    ...
                    case 10://炸弹
                        ...
                        break;
                    case 11://火箭
                        cc.find('Canvas/root').getComponent('pdk_replay').playRocketAnimation('2');
                        break;
                    default:
                        break;
                }
    ...
    clearOutCard: function () {
        for (var i = this.out_node.childrenCount - 1; i > -1; i--) {
            ...
            if (node.name == 'top_card_ani1_right') {
                ...
                //this.node.parent.getComponent('pdk_game').shunziPool.put(node);
                node.getComponent(sp.Skeleton).enabled = false;
            }
            else if (node.name == 'liandui_ani') {
                //this.node.parent.getComponent('pdk_game').lianduiPool.put(node);
                node.getComponent(sp.Skeleton).enabled = false;
            }
