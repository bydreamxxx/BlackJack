...
cc.Class({
    ...
    callScoreRet: function (score) {
        ...
        // var spriteFrame = this.atlas_game.getSpriteFrame(str);
        // cc.find('head/callscore', this.node).getComponent(cc.Sprite).spriteFrame = spriteFrame;
    ...
    addChangeCard(cards) {
        ...
        this._handCards = pdk.sortShowCards(this._handCards.concat(cards));
    ...
    showBottomCard: function (cardlist) {
        ...
        var finish = function () {
            ...
            this.scheduleOnce(function () {
                ...
                this._handCards = pdk.sortShowCards(this._handCards.concat(cardlist));
                this.playSendCards(this._handCards);
            }.bind(this), 0.5);
        }.bind(this);
    ...
    calSpecialBottom: function (cardlist) {
        this.node.parent.getComponent('pdk_replay').calSpecialBottom(cardlist);
    },
                ...
                switch (type) {
                    case 3://三张
                        ...
                        if (aaa && cc._replayPDKBombAAA) {
                            cc.find('Canvas/root').getComponent('pdk_replay').playBombAnimation('zuo');
                        }
                        break;
                    case 5://顺子
                    ...
                    case 10://炸弹
                        ...
                        break;
                    case 11://火箭
                        cc.find('Canvas/root').getComponent('pdk_replay').playRocketAnimation('3');
                        break;
                    default:
                        break;
                }
