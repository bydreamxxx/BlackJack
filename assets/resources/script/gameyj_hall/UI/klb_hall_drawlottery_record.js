...
cc.Class({
    ...
    show(msg) {
        this.initPlayerList(msg.listList);
    },
    ...
    initPlayerList(data) {
        ...
        for (let i = 0; i < playerNum; i++) {
            ...
            item.getComponent('klb_hall_drawlottery_recorditem').initPlayerInfo(this.playerList[i]);
            item.index = i;
        ...
        for (let i = 0; i < items.length; ++i) {
            ...
            if (isDown) {
                ...
                if (viewPos.y < -this.bufferZone && newY < 0) {
                    ...
                    items[i].getComponent('klb_hall_drawlottery_recorditem').initPlayerInfo(this.playerList[itemId]);
