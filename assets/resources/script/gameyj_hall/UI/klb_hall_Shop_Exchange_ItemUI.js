...
cc.Class({
    ...
    onClick: function(event, data){
        if(this.itemData.subType != 5){//实物兑换
            var UI = cc.dd.UIMgr.getUI("gameyj_hall/prefabs/klb_hall_Shop_YuanBao_Exchange");
            if(UI)
                cc.dd.UIMgr.destroyUI(UI);
            cc.dd.UIMgr.openUI("gameyj_hall/prefabs/klb_hall_Shop_YuanBao_Exchange", function(prefab){
