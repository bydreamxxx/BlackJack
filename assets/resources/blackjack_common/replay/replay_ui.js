...
let replay_ui = cc.Class({
    ...
    onLoad: function () {
        ...
        if (this.hasSlide) {
            ...
            this.faster_speed = cc.find("handler_bar/speedButton/cfmj-ssu-btn", this.node);
            this.normal_speed.active = true;
            this.fast_speed.active = false;
            this.faster_speed.active = false;
        }
    ...
    updateGameUI: function () {
        ...
        // var desk_info_ui = cc.find('Canvas/desk_info').getComponent(this.mjComponentValue.deskInfo);
    ...
    updateGameUIAfterMsg: function () {
        ...
        //     for (var i = 1; i < 4; ++i) {
        //         var menu_list = cc.find("Canvas/game_menu_list_" + i).getComponent(this.mjComponentValue.gameMenuList);
        //         menu_list.closeMenuAndOptions();
        //     }
        // }
    },
    ...
    updateGameUIBeforeMsg: function (id, msg) {
        ...
        //         play_list.getComponent(this.mjComponentValue.playerList).playerUpdateZsq();
        //     }
        // }
    },
    ...
    onClickChangeSpeed() {
        ...
        if (this.speed == SPEED_TYPE.FAST) {
            this.speed = SPEED_TYPE.FASTER;
            this.normal_speed.active = false;
            this.fast_speed.active = false;
            this.faster_speed.active = true;
        } else if(this.speed == SPEED_TYPE.FASTER){
            this.speed = SPEED_TYPE.NORMAL;
            this.normal_speed.active = true;
            this.fast_speed.active = false;
            this.faster_speed.active = false;
