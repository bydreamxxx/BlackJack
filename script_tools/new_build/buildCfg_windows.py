...
COCOS_CMD = " C:/CocosDashboard_1.0.11/resources/.editors/Creator/2.4.6/CocosCreator.exe " \
            ...
            "buildPath=E:/build-246;debug=false;autoCompile=false;xxteaKey=bdd7b8ea-7650-43;apiLevel=android-29;appABIs=['armeabi-v7a','x86','arm64-v8a','x86_64'];md5Cache=false;\" ".format(COCOS_PROJECT_PATH)
# ----------------------------以上需要更改成自己的目录------------------------
...
# 1.8.2
NATIVE_PATH = "E:/build-246/jsb-default"
