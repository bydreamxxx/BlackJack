...
def cocos_build():
    cmd = "/Applications/CocosCreatorFiles/Creator/2.4.6/CocosCreator.app/Contents/MacOS/CocosCreator --path ../../../  --build \"platform=web-mobile;debug=false;buildPath=./build-246;md5Cache=true;inlineSpriteFrames=true\" "
    os.system(cmd)
