...
static NSString *kAPPContentTitle = @"神经德州 约牌神器 一键进房";
static NSString *kAPPContentDescription = @"";
static NSString *kAppContentExInfo = @"<xml>extend info</xml>";
static NSString *kAppContnetExURL = @"sjtexas://roomid:123456";
static NSString *kAppMessageExt = @"这是第三方带的扩展字段";
